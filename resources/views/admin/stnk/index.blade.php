                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover" id="stnk-table">
...
@section('js')  
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#stnk-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.STNK.index') }}',
                columns: [
                    {
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
            ...
            $('#stnk-table').DataTable().on('draw', function() {
            ...
            $('#btn-save').click(function() {
                ...
                var type = "POST";
                var ajaxurl = '{{ route('admin.STNK.store') }}';
                ...
                if (state == "update") {
                    ...
                    var id = $('#id').val();
                    type = "PUT";
                    ajaxurl = '{{ route('admin.STNK.store') }}' + '/' + id;
                }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (state == "save") {
                            ...
                            $('#stnk-table').DataTable().draw(false);
                            $('#stnk-table').DataTable().on('draw', function() {
                                $('[data-toggle="tooltip"]').tooltip();
                            });
                        } else {
            ...
            $('body').on('click', '#btn-edit', function() {
                var id = $(this).val();
                $.get('{{ route('admin.STNK.index') }}' + '/' + id + '/edit', function(data) {
                    $('#company-form').find('.form-control').removeClass('is-invalid is-valid');
                    $('#id').val(data.id);
